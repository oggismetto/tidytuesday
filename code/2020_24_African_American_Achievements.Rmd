...
accomplishments <- firsts %>%
  select(accomplishment, category) %>%
...
african_american <- ggdraw() +
  ...
  draw_plot(density, scale = 0.43, x = -0.3, y = 0.15) + 
  draw_label("African American Achievements, a complex story", color = "black", size = 25, angle = 0, y = 0.95) +
...
\n(MARTIN LUTHER KING JR., 1963) ", color = "black", size = 7, angle = 0, x = 0.2, y = 0.23, fontfamily = "TT Courier New") + 
  ...
  draw_label("#BlackLivesMatter", color = "black", size = 10, angle = 0, x = 0.85, y = 0.85, fontface = "bold")
