...
tree <- ggplot(segment(ddata_x)) +
  ...
  theme(
    ...
    plot.subtitle = element_text(family = "Arial", colour = "#ffcc00", face = "bold", size = 20, margin = margin(t = 10, b = 22)),
...
ggdraw(tree) +
  draw_image(here("other", "imgs", "1.jpg"), hjust = 0, x = 0.27, y = 0.35, scale = 0.2)+
  draw_image(here("other", "imgs", "0645052_PE703185_S4.jpg"), hjust = 0, x = 0.27, y = -0.4, scale = 0.2) + 
  draw_label("A TV bench,\n180x42x39 cm", color = "black", size = 10, angle = 0, x = 0.76, y = 0.8)+ 
